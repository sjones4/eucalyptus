 ...
 *
 */
public class ResourcegroupsMessageValidation {

  public static class ResourcegroupsMessageValidationAssistant implements MessageValidation.ValidationAssistant {
    @Override
  ...
  public enum FieldRegexValue {
    ...
    // Enums
    ENUM_QUERYTYPE("TAG_FILTERS_1_0"),
