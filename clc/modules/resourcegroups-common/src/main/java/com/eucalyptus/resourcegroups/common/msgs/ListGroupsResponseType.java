...
public class ListGroupsResponseType extends ResourcegroupsMessage {


  private java.util.ArrayList<Group> groups;
  ...
  public void setGroups( final java.util.ArrayList<Group> groups ) {
    this.groups = groups;
  }
