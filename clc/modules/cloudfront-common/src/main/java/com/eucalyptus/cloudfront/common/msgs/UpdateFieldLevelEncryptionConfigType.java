...
@HttpRequestMapping(method="PUT", uri="/2018-06-18/field-level-encryption/{Id}/config")
@HttpContent(payload="fieldLevelEncryptionConfig")
public class UpdateFieldLevelEncryptionConfigType extends CloudfrontMessage {
