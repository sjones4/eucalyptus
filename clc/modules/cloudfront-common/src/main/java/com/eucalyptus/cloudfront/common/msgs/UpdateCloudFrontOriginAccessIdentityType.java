...
@HttpRequestMapping(method="PUT", uri="/2018-06-18/origin-access-identity/cloudfront/{Id}/config")
@HttpContent(payload="cloudFrontOriginAccessIdentityConfig")
public class UpdateCloudFrontOriginAccessIdentityType extends CloudfrontMessage {
