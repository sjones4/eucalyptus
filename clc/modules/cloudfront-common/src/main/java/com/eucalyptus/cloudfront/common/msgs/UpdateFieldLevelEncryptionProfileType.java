...
@HttpRequestMapping(method="PUT", uri="/2018-06-18/field-level-encryption-profile/{Id}/config")
@HttpContent(payload="fieldLevelEncryptionProfileConfig")
public class UpdateFieldLevelEncryptionProfileType extends CloudfrontMessage {
