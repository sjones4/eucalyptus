...
import com.eucalyptus.cloudtrail.common.msgs.ErrorResponse;
 ...
 */
@ComponentNamed
public class CloudtrailErrorHandler extends ErrorHandlerSupport {
  private static final Logger LOG = Logger.getLogger( CloudtrailErrorHandler.class );
  private static final String INTERNAL_FAILURE = "InternalFailure";

  public CloudtrailErrorHandler() {
  ...
  protected BaseMessage buildErrorResponse( final String correlationId,
    ...
    final com.eucalyptus.cloudtrail.common.msgs.Error error = new com.eucalyptus.cloudtrail.common.msgs.Error( );
