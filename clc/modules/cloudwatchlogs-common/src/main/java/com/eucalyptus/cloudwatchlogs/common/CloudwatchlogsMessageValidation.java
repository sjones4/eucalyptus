 ...
 *
 */
public class CloudwatchlogsMessageValidation {

  public static class CloudwatchlogsMessageValidationAssistant implements MessageValidation.ValidationAssistant {
    @Override
  ...
  public enum FieldRegexValue {
    ...
    ENUM_QUERYSTATUS("Scheduled|Running|Complete|Failed|Cancelled"),
    ;
