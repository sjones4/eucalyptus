...
public class GetLogRecordResponseType extends CloudwatchlogsMessage {


  private LogRecord logRecord;

  @com.fasterxml.jackson.annotation.JsonProperty("logRecord")
  public LogRecord getLogRecord( ) {
    return logRecord;
  }

  public void setLogRecord( final LogRecord logRecord ) {
