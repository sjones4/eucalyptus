...
public class DescribeResourcePoliciesResponseType extends CloudwatchlogsMessage {


  @FieldRange(min=1)
  private String nextToken;
  private java.util.ArrayList<ResourcePolicy> resourcePolicies;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("resourcePolicies")
  public java.util.ArrayList<ResourcePolicy> getResourcePolicies( ) {
    return resourcePolicies;
  }

  public void setResourcePolicies( final java.util.ArrayList<ResourcePolicy> resourcePolicies ) {
