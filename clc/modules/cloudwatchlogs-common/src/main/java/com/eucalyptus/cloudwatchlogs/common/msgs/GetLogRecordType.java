...
public class GetLogRecordType extends CloudwatchlogsMessage {

  @Nonnull
  private String logRecordPointer;

  @com.fasterxml.jackson.annotation.JsonProperty("logRecordPointer")
  public String getLogRecordPointer( ) {
    return logRecordPointer;
  }

  public void setLogRecordPointer( final String logRecordPointer ) {
