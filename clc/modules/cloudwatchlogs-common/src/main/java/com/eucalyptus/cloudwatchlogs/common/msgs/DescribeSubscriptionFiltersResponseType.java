...
public class DescribeSubscriptionFiltersResponseType extends CloudwatchlogsMessage {


  @FieldRange(min=1)
  private String nextToken;
  private java.util.ArrayList<SubscriptionFilter> subscriptionFilters;
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("subscriptionFilters")
  public java.util.ArrayList<SubscriptionFilter> getSubscriptionFilters( ) {
    return subscriptionFilters;
  }

  public void setSubscriptionFilters( final java.util.ArrayList<SubscriptionFilter> subscriptionFilters ) {
