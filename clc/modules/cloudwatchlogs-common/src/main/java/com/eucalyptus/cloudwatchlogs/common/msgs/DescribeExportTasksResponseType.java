...
public class DescribeExportTasksResponseType extends CloudwatchlogsMessage {


  private java.util.ArrayList<ExportTask> exportTasks;
  @FieldRange(min=1)
  private String nextToken;

  @com.fasterxml.jackson.annotation.JsonProperty("exportTasks")
  public java.util.ArrayList<ExportTask> getExportTasks( ) {
    return exportTasks;
  }

  public void setExportTasks( final java.util.ArrayList<ExportTask> exportTasks ) {
