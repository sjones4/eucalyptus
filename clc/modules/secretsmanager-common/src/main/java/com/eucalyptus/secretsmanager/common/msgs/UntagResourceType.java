...
public class UntagResourceType extends SecretsmanagerMessage {

  @Nonnull
  @FieldRange(min=1, max=2048)
  private String secretId;
  @Nonnull
  private java.util.ArrayList<String> tagKeys;
  ...
  public java.util.ArrayList<String> getTagKeys( ) {
    return tagKeys;
  }

  public void setTagKeys( final java.util.ArrayList<String> tagKeys ) {
