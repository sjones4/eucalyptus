 ...
 *
 */
public class SecretsmanagerMessageValidation {

  public static class SecretsmanagerMessageValidationAssistant implements MessageValidation.ValidationAssistant {
    @Override
