...
public class DescribeSecretResponseType extends SecretsmanagerMessage {
  ...
  private SecretVersionsToStagesMapType versionIdsToStages;
  ...
  public SecretVersionsToStagesMapType getVersionIdsToStages( ) {
    return versionIdsToStages;
  }

  public void setVersionIdsToStages( final SecretVersionsToStagesMapType versionIdsToStages ) {
