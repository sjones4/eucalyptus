    ...
    final Cluster cluster = Cluster.builder( )
        ...
        .withNettyOptions( new NettyOptions( ) {
          ...
          public EventLoopGroup eventLoopGroup( final ThreadFactory threadFactory ) {
            return new NioEventLoopGroup( 0, Threads.threadFactory( "cassandra-client-events-%d" ) );
          }
          @Override
          public Timer timer( final ThreadFactory threadFactory ) {
            return super.timer( Threads.threadFactory( "cassandra-client-timer-%d" ) );
          }
        } )
