...
public class Trail extends EucalyptusData {
  ...
  public void setHasCustomEventSelectors( final Boolean hasCustomEventSelectors ) {
  ...
  public void setHomeRegion( final String homeRegion ) {
