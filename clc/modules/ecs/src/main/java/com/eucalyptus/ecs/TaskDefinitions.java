...
public interface TaskDefinitions {
  ...
  @TypeMapper
  public enum TaskDefinitionToTaskDefinitionTransform implements Function<TaskDefinition,com.eucalyptus.ecs.common.model.TaskDefinition> {
    INSTANCE;

    @Nullable
    @Override
    public com.eucalyptus.ecs.common.model.TaskDefinition apply( @Nullable final TaskDefinition taskDefinition ) {
      return taskDefinition == null ?
          null :
          new com.eucalyptus.ecs.common.model.TaskDefinition( )
              ...
              .withContainerDefinitions( Collections2.transform(
                  ...
                  TypeMappers.lookup( ContainerDefinition.class, com.eucalyptus.ecs.common.model.ContainerDefinition.class ) ) );
    }
  }

  @TypeMapper
  public enum ContainerDefinitionToContainerDefinitionTransform implements Function<ContainerDefinition,com.eucalyptus.ecs.common.model.ContainerDefinition> {
    INSTANCE;

    @Nullable
    @Override
    public com.eucalyptus.ecs.common.model.ContainerDefinition apply( @Nullable final ContainerDefinition containerDefinition ) {
      return containerDefinition == null ?
          null :
          new com.eucalyptus.ecs.common.model.ContainerDefinition( )
  ...
  @TypeMapper
  public enum ContainerDefinitionToContainerDefinitionReverseTransform implements Function<com.eucalyptus.ecs.common.model.ContainerDefinition,ContainerDefinition> {
    INSTANCE;

    @Nullable
    @Override
    public ContainerDefinition apply( @Nullable final com.eucalyptus.ecs.common.model.ContainerDefinition containerDefinition ) {
      return containerDefinition == null ?
          null :
