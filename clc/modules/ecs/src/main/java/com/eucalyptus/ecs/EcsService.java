...
import com.eucalyptus.ecs.common.EcsMetadatas;
import com.eucalyptus.ecs.common.model.*;
...
public class EcsService {
  ...
  private static final Logger logger = Logger.getLogger( EcsService.class );

  private final Clusters clusters;
  private final TaskDefinitions taskDefinitions;

  @Inject
  public EcsService( final Clusters clusters,
  ...
  public EcsMessage createCluster( final CreateClusterRequest request ) throws EcsException {
    ...
    return request.reply( new CreateClusterResult( )
        .withCluster( TypeMappers.transform( cluster, com.eucalyptus.ecs.common.model.Cluster.class ) ) );
  }
  ...
  public EcsMessage deleteCluster( final DeleteClusterRequest request ) throws EcsException {
    ...
    final Predicate<? super Cluster> accessible =
        EcsMetadatas.filteringFor( Cluster.class ).byPrivileges( ) .buildPredicate( );
  ...
  public EcsMessage describeClusters( final DescribeClustersRequest request ) throws EcsException {
    ...
    final Context ctx = Contexts.lookup( );
    final AccountFullName accountFullName = ctx.getUserFullName( ).asAccountFullName( );
    final Predicate<? super Cluster> requestedAndAccessible = EcsMetadatas.filteringFor( Cluster.class )
    ...
    try {
      describeClustersResult.getClusters( ).addAll( clusters.list(
          ...
          TypeMappers.lookup( Cluster.class, com.eucalyptus.ecs.common.model.Cluster.class ) ) );
    } catch ( Exception e ) {
      throw handleException( e );
    }
  ...
  public EcsMessage describeTaskDefinition( final DescribeTaskDefinitionRequest request ) throws EcsException {
    ...
    try {
      describeTaskDefinitionResult.setTaskDefinition( taskDefinitions.lookupByName( //TODO:STEVE: authorization
          ...
          TypeMappers.lookup( TaskDefinition.class, com.eucalyptus.ecs.common.model.TaskDefinition.class ) ) );
    } catch ( Exception e ) {
  ...
  public EcsMessage listTaskDefinitions( final ListTaskDefinitionsRequest request ) throws EcsException {
    ...
    final Context ctx = Contexts.lookup( );
    final AccountFullName accountFullName = ctx.getUserFullName( ).asAccountFullName( );
    final Predicate<? super TaskDefinition> requestedAndAccessible = EcsMetadatas.filteringFor( TaskDefinition.class )
        .byPrivileges( )
        .buildPredicate( );
    try {
  ...
  public EcsMessage registerTaskDefinition( final RegisterTaskDefinitionRequest request ) throws EcsException {
      ...
      public TaskDefinition get( ) {
        try {
          final TaskDefinition taskDefinition = TaskDefinition.create(
           ...
           for ( final com.eucalyptus.ecs.common.model.ContainerDefinition definition : request.getContainerDefinitions( )  ) {
    ...
    return request.reply( new RegisterTaskDefinitionResult( )
        .withTaskDefinition( TypeMappers.transform( taskDefinition, com.eucalyptus.ecs.common.model.TaskDefinition.class ) ) );
  }
