...
import static com.eucalyptus.ecs.common.EcsMetadata.ClusterMetadata;
...
public interface Clusters {
  ...
  @TypeMapper
  public enum ClusterToClusterTransform implements Function<Cluster,com.eucalyptus.ecs.common.model.Cluster> {
    INSTANCE;

    @Nullable
    @Override
    public com.eucalyptus.ecs.common.model.Cluster apply( @Nullable final Cluster cluster ) {
      return cluster == null ?
          null :
          new com.eucalyptus.ecs.common.model.Cluster( )
