...
public class EcsPipeline extends FilteredPipeline {
  private final HmacUserAuthenticationStage auth;
  private final Set<String> servicePathPrefixes = ImmutableSet.of( "/services/Ecs" );
  ...
  public ChannelPipeline addHandlers( final ChannelPipeline pipeline ) {
    ...
    pipeline.addLast( "ecs-binding", new EcsBinding( ) );
    return pipeline;
  }
