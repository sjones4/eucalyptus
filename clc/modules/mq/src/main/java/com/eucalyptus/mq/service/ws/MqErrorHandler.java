...
import com.eucalyptus.mq.common.msgs.ErrorResponse;
 ...
 */
@ComponentNamed
public class MqErrorHandler extends ErrorHandlerSupport {
  private static final Logger LOG = Logger.getLogger( MqErrorHandler.class );
  private static final String INTERNAL_FAILURE = "InternalFailure";

  public MqErrorHandler() {
  ...
  protected BaseMessage buildErrorResponse( final String correlationId,
    ...
    final com.eucalyptus.mq.common.msgs.Error error = new com.eucalyptus.mq.common.msgs.Error( );
